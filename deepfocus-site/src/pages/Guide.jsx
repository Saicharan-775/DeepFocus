  ...
  return (
    <div className="pt-24 pb-20">
      <div className="container mx-auto px-4 max-w-5xl">
        <h1 className="text-5xl md:text-6xl font-black mb-20 bg-gradient-to-r from-green-400 to-emerald-400 bg-clip-text text-transparent text-center">
          How DeepFocus Works
        </h1>
          ...
          <div>
            ...
            <ol className="space-y-8 text-lg">
              <li className="flex items-start">
                <div className="bg-emerald-400/80 w-10 h-10 rounded-xl flex-shrink-0 flex items-center justify-center font-bold mr-4 mt-1 text-xl">1</div>
                <div>
              ...
              <li className="flex items-start">
                <div className="bg-emerald-400/80 w-10 h-10 rounded-xl flex-shrink-0 flex items-center justify-center font-bold mr-4 mt-1 text-xl">2</div>
                <div>
              ...
              <li className="flex items-start">
                <div className="bg-emerald-400/80 w-10 h-10 rounded-xl flex-shrink-0 flex items-center justify-center font-bold mr-4 mt-1 text-xl">3</div>
                <div>
              ...
              <li className="flex items-start">
                <div className="bg-emerald-400/80 w-10 h-10 rounded-xl flex-shrink-0 flex items-center justify-center font-bold mr-4 mt-1 text-xl">4</div>
                <div>
